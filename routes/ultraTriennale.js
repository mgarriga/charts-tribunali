...
//
// function getUTSuPendentiByTribunaleAverage(tribunale,criteria,years,callback){
//   partial = []
//   ut.getUTSuPendentiAvg('$tribunale',years).toArray(function (err, data){
//     if (err) {
//       console.log(err)
//       return
//     }
...
//         filter = data[index]
//       }
//       ut.getUTSuPendentiAvg('$'+criteria,years).toArray(function (err, data){
//         if (err) {
//           console.log(err)
//           return
//         }
...
//         }
//         res = ut.formatUT(partial,"Su Pendenti Average")
//         callback(res)
//       })
...
// function getUTObiettiviByTribunaleAverage(tribunale,criteria,years,callback){
//   tr.getTribunaleDetail(tribunale).toArray(function(err,data){
//     if (err) {
//       console.log(err)
//       return
...
//     }
//     partial = []
//     ut.getUTObiettiviAvg('$tribunale',years,res).toArray(function (err,data){
//       if (err){
//         console.log(err)
//         return
//       }
...
//         }
//       }
//       ut.getUTObiettiviAvg('$'+criteria,years,res).toArray(function (err, data){
//         if (err) {
//           console.log(err)
//           return
//         }
...
//           partial.push(data[index])
//         }
//         var res = ut.formatUT(partial," Obiettivi Average")
//         callback(res)
//       })
//     })
//   })
...
//   })
//
//   getUTSuPendentiByTribunaleAverage(tribunale,criteria,years,function(result1){
//       // console.log(JSON.stringify(result1))
//     getUTObiettiviByTribunaleAverage(tribunale,criteria,years,function(result2){
//       var result = {
//         "labels":result2['labels'],
//         "datasets":result1['datasets'].concat(result2['datasets'])
//       }
//       res.json(result)
//     })
//   })
